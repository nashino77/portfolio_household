...
var transformObjectUsingCallbackRecursive = function (data, fn, overwrite) {
    ...
    if ((0, util_1.isFormData)(data) || (0, util_1.isURLSearchParams)(data)) {
        ...
        if (overwrite) {
            ...
            series = (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(series), false);
            try {
                for (var series_1 = (0, tslib_1.__values)(series), series_1_1 = series_1.next(); !series_1_1.done; series_1_1 = series_1.next()) {
                    var _d = (0, tslib_1.__read)(series_1_1.value, 1), key = _d[0];
                    data.delete(key);
                }
            }
        ...
        if (overwrite && !Array.isArray(data)) {
            try {
                for (var series_2 = (0, tslib_1.__values)(series), series_2_1 = series_2.next(); !series_2_1.done; series_2_1 = series_2.next()) {
                    var _e = (0, tslib_1.__read)(series_2_1.value, 1), key = _e[0];
                    delete data[key];
                }
            }
    ...
    try {
        for (var series_3 = (0, tslib_1.__values)(series), series_3_1 = series_3.next(); !series_3_1.done; series_3_1 = series_3.next()) {
            var _f = (0, tslib_1.__read)(series_3_1.value, 2), key = _f[0], value = _f[1];
...
var transformObjectUsingCallback = function (data, fn, options) {
    fn = (0, decorators_1.applyCaseOptions)(fn, (0, tslib_1.__assign)({ stripRegexp: /[^A-Z0-9[\]]+/gi }, options === null || options === void 0 ? void 0 : options.caseOptions));
...
var createObjectTransformers = function (options) {
    ...
    try {
        for (var functionNames_1 = (0, tslib_1.__values)(functionNames), functionNames_1_1 = functionNames_1.next(); !functionNames_1_1.done; functionNames_1_1 = functionNames_1.next()) {
